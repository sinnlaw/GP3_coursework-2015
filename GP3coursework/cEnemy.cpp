...
//		cModel::m_mdlPosition.x = PLAYFIELDX;
//	}
	cModel::m_mdlPosition.x = rand() % (RANDOMPOSXMAX - RANDOMPOSXMIN) + RANDOMPOSXMIN;
	cModel::m_mdlPosition.y = 0.0f;
	cModel::m_mdlPosition.z = PLAYFIELDX;
	...
	cModel::m_mdlDirection.z = -(float)glm::sin(cModel::m_mdlRotation);
...
{
	cModel::m_mdlPosition += cModel::m_mdlDirection * 10.0f * elapsedTime;
